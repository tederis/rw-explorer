...
// configuration step. It creates a namespace called `rw_explorer`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", rw_explorer::cmake::project_name, rw_explorer::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", rw_explorer::cmake::project_version);
      return EXIT_SUCCESS;
    }
